...
public class HumanService {
    ...
    public HumanService(HumanRepository<Student> injectedStudentRepository, HumanRepository<Professor> injectedProfessorRepository) {
    ...
    public List<Human> getAllHuman() {
        ...
        allHumans.addAll(studentRepository.getAll());
        allHumans.addAll(professorRepository.getAll());


        //3.1 Add 4 objects inside each repository
        exercise1(studentRepository);

        System.out.println(studentRepository.getAll());

        exercise2(professorRepository);

        System.out.println(professorRepository.getAll());

        exercise3(studentRepository);

        System.out.println(studentRepository.getAll());

        exercise4(professorRepository);

        System.out.println(professorRepository.getAll());

        //3.4  Delete 2 objects inside each repository (1 that was modified, 1 that wasn’t)
        exercise5(studentRepository);
    ...
    public void exercise5(HumanRepository<Student> studentRepository) {
        System.out.println("\n Objects deleted in student repository");
        studentRepository.deleteById("712");
        studentRepository.deleteById("381");
    }

    public void exercise4(HumanRepository<Professor> professorRepository) {
    ...
    public void exercise3(HumanRepository<Student> studentRepository) {
    ...
    public void exercise2(HumanRepository<Professor> professorRepository) {
    ...
    public void exercise1(HumanRepository<Student> studentRepository) {
